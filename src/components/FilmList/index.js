        ...
        <div className="dy_pro_list">
            ...
            <div className="dy_content">
                <div className="dy_title">
                    <h3 className="dy_show_name">{rowData.filmName}</h3><FilmVersionIcon data= {{vd:rowData.vd}}/>
                </div>
            ...
            <div className="dy_btn_wrap"><Button type="warning" inline size="small" href="/cinema">购票</Button></div>
        </div>
    )
}
